...
r = rank
alpha = .2
plot(1:upper_bound_rank, fdrs[1][1:upper_bound_rank], label=L"True FDR $r = 20$", line = (3, :solid))
plot!(1:upper_bound_rank, fdrs[2][1:upper_bound_rank], label=L"True FDR $r = 40$", line = (3, :dot))
...
plot(1:upper_bound_rank, fds[1][1:upper_bound_rank], label=L"True FD $r = 20$", line = (3, :solid))
plot!(1:upper_bound_rank, fds[2][1:upper_bound_rank], label=L"True FD $r = 40$", line = (3, :dot))
